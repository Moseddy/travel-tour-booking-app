      ...
      <Container>
        <Row>
          <Col lg='3'>
            <div className="logo">
              <img src={logo} alt="" />
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, alias!</p>
          ...
          <Col lg='3'>
            ...
            <ListGroup className="footer__quick-links">
                  <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                    ...
                    <p className="mb-0">Magboro, Ogun state</p>
                  </ListGroupItem>
                  ...
                  <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                    ...
                    <p className="mb-0">iamedwin@gmail.com</p>
                  </ListGroupItem>
                  ...
                  <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                    ...
                    <p className="mb-0">08130349510</p>
                  </ListGroupItem>
            </ListGroup>
          </Col>

          <Col lg='12' className='text-center pt-5'>
            <p className="copyright">Copyright &copy; {year}, designed and developed by EdenTech. All Rights Reserved </p>
          </Col>
        </Row>
      </Container>
    </footer>
